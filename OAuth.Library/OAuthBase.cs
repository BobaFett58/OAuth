...

    {
...

        {
            ...
            if (!string.IsNullOrEmpty(filter))
                parameters.Add(new QueryParameter(HttpUtility.UrlEncode("filter[created_at_min]").Replace("%5b", "%5B").Replace("%5d", "%5D"), HttpUtility.UrlEncode(filter)));
        ...
        public string GenerateSignature(
            ...
            string httpMethod, string timeStamp, string nonce, string filter, string status,
...

        {
            ...
            return GenerateSignature(
                ...
                httpMethod, timeStamp, nonce, SignatureTypes.HMACSHA1, null, filter, status,
